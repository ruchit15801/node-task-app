...
SibApiV3Sdk.ApiClient.instance.authentications['api-key'].apiKey = SANDBLUE_API_KEY
new SibApiV3Sdk.TransactionalEmailsApi().sendTransacEmail({

    "sender":{ "email":"ruchit.1580@gmail.com", "name":"Ruchitlukhi"},
